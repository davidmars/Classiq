...
class Wysiwyg{
    ...
    constructor(){
        ...
        setTimeout(function(){
            me._boot();
            me._initListeners();
            window.cqAdmin = new __WEBPACK_IMPORTED_MODULE_14__CqAdmin__["a" /* default */]();
        },10)
    ...
    _boot(){
         ...
         */
        this.recordEditor=new __WEBPACK_IMPORTED_MODULE_13__unique_instances_cq_edit_record_box_CqEditRecordBox__["a" /* default */]($("#the-cq-record-editor"));
    }
    ...
    _initListeners(){
        ...
        $body.on(Pov.events.DOM_CHANGE_OR_READY,function(){
            ...
            __WEBPACK_IMPORTED_MODULE_0__DisplayObject__["a" /* default */].__fromDom(__WEBPACK_IMPORTED_MODULE_12__cq_fields_cq_field_crop_CqFieldCrop__["a" /* default */],"cq-field-crop");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cq_browse_records_CqBrowseRecordsList__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cq_new_record_CqNewRecord__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CqBrowseRecordsList__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cq_progress_bar_CqProgressBar__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cq_tip_CqTip__ = __webpack_require__(12);
    ...
    constructor($main){
        ...
        this.$btnUpload.on("input "+__WEBPACK_IMPORTED_MODULE_3__Wysiwyg__["a" /* default */].events.CHANGED,function(e){
            ...
            for(let file of $(this).get(0).files){
                 ...
                 * @type {CqProgressBar}
                 */
                let progressbar=new __WEBPACK_IMPORTED_MODULE_4__cq_progress_bar_CqProgressBar__["a" /* default */]($preview.find("[cq-progress-bar]"));
 ...
 *
 */
class CqFieldCrop extends __WEBPACK_IMPORTED_MODULE_0__DisplayObject__["a" /* default */]{
    /**
     *
     * @param {JQuery} $main
     */
...
/* harmony export (immutable) */ __webpack_exports__["a"] = CqFieldCrop;
